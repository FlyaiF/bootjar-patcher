...
The `find` command SHOULD search both outer entries and nested entries by default.
...
Snippet output SHOULD emit commented YAML operations that the user can copy into a
patch plan.
